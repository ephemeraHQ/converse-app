/*
note(lustig):
the tricky part here is trying to decipher what's going on and use inbox id as the index for wallets, 
but we don't yet hav a mapping.
since this ui is changing anyway, we can refactor and conslidated into a narrower store. 
i'm leaving this for now, but we'll remove
*/
...
//               const xmtpInboxId = await Client.findInboxIdFromAddress(
//                 walletAddress
//               );
