...
export const handleDecryptedLocalAttachment = async (args: {
  ...
  let filename =
    decryptedLocalAttachment.filename || decryptedLocalAttachment.fileUri.split("/").slice(-1)[0]
  ...
  return getLocalAttachment(messageId, filename, decryptedLocalAttachment.mimeType)
}
