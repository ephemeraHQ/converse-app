...
export const ConversationCreateSearchInput = memo(function ConversationCreateSearchInput() {
  ...
  const handleKeyPress = (e: NativeSyntheticEvent<TextInputKeyPressEventData>) => {
    ...
    const { searchTextValue, searchSelectedUserInboxIds } = conversationStore.getState()
    const selectedInboxIdChip = useConversationCreateSearchInputStore.getState().selectedChipInboxId
    ...
    if (key === "Backspace" && !searchTextValue) {
      ...
      if (selectedInboxIdChip !== null) {
        ...
        useConversationCreateSearchInputStore.getState().actions.setSelectedChipInboxId(null)
      ...
      <HStack style={styles.$inputContainer}>
        ...
        <HStack style={styles.$chipContainer}>
          {searchSelectedUserInboxIds.map((inboxId) => (
            <ConversationCreateSearchInputChip key={inboxId} inboxId={inboxId} />
          ))}
          <TextInput
