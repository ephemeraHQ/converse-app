...
import { useMessageHasReactions } from "@/features/conversation/conversation-chat/conversation-chat-message/conversation-message.utils"
...
type ConversationChatPreviewProps = {
  topic: ConversationTopic
}

export const ConversationChatPreview = ({ topic }: ConversationChatPreviewProps) => {
